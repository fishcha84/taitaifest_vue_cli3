          ...
          <form action="" @click.prevent="payOrder(orderId)" class="orderform">
            <table class="container-fluid ordertable" >
              <tr class="row orderrow" >
                <td class="col-md-4 col-xs-12 ordertd1"  >
                    order id
                </td>
              ...
              <tr class="row">
                  <td class="col-md-4 col-xs-12 ordertd1 align-middle" >
                    payment status
                  </td>
                  <td class="col-md-8 col-xs-12">
            ...
            <button v-if="!order.is_paid" class="btn btn-outline-danger d-block" style="width:100%;margin-top:10px;margin-bottom:10px;">pay it!</button>
          </form>
        </div>
      </div>  
    </div>
