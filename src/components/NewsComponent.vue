<template>
  <div class="newscomponent">
    <div v-if="!showContent">
      <div class="container-fluid shortnewsdiv" v-for="(item, idx) in news" :key="idx" @click="a(item,idx)" data-bs-toggle="tooltip" data-bs-placement="bottom" title="clicking for more..."  >
          <div class="row">
    ...
    <div class="shortnewsdiv" v-if="showContent" @click="b()" data-bs-toggle="tooltip" data-bs-placement="bottom" title="clicking back" >
